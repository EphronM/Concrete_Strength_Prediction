...
center_text('Cement')
cement = st.sidebar.slider('', 0, 500,303)
center_text('superplastic')
superplastic = st.sidebar.slider('', 0, 30,0)
center_text('water')
water = st.sidebar.slider('', 100, 200,150)
center_text('slag')
slag = st.sidebar.slider('', 0, 350,0)
center_text('fineagg')
fineagg = st.sidebar.slider('', 500, 1000,600)
center_text('ash')
ash = st.sidebar.slider('', 100, 200,120)
center_text('coarseagg')
coarseagg = st.sidebar.slider('', 500, 1000,700)
